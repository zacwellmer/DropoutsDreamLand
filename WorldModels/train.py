...
def initialize_settings(sigma_init=0.1, sigma_decay=0.9999):
  ...
  filedir = 'results/{}/{}/eval_input{}_hidden{}_log/'.format(exp_name, env_name, config_args.rnn_input_dropout, config_args.rnn_hidden_dropout)
...
def slave():
  global env, test_env
  env = make_env(args=config_args, dream_env=config_args.dream_env) # training in dreams not supported yet
