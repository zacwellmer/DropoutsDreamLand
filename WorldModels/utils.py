...
PARSER.add('--dream_env', required=True, help='whether to train controller in dream')
...
PARSER.add('--collect_trajectories_with_expert_policy_rate', required=True, type=float, help='portion of trajectories during extract using an expert policy. Only works for CarRacing')
...
PARSER.add('--rnn_input_dropout', required=True, type=float, help='dropout value used on the LSTM input params at training and evaluation') 
PARSER.add('--rnn_hidden_dropout', required=True, type=float, help='dropout value used on the LSTM hidden params at training and evaluation') 
